...
def run_test1_2000(popsize_scale):
    ...
    for seed in random_seeds:
        for p in range(11):
            ...
            e.output_path = e.output_path.replace('/y', '/divorce_prob/divorce_prob_{:.2f}/burned_{}_s{}_y'.format(pp, str(popsize_scale), str(seed)))
            e.output_path = e.output_path.replace('_run_output', '../../sandbox/experiment_output/_burned_run_output_2')
            #print(e.params.keys())
